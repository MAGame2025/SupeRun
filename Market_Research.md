...
Within the action genre, “horde survival” roguelike shooters have emerged as a popular niche since 2022 with the release of the hit game Vampire Survivors. It popularized this wave of arena survival games where players fight endless hordes and collect upgrades. Vampire Survivors – a simple 2D indie game – went viral, selling over 6 million copies on Steam (as of 2024) and generating an estimated [$20+ million in revenue.](https://levvvel.com/vampire-survivors-statistics/#:~:text=Vampire%20Survivors%20has%20generated%20an,million%20in%20revenue%20on%20Steam)
It peaked at ~77,000 concurrent players on Steam and earned 98% positive user reviews across 200k+ reviews. Its success sparked a flood of similar titles, creating a vibrant subgenre (The game also released for mobile and with it came a big wave of clones and knockoffs with varying degrees of success). The combined player base for action-roguelike survivors remained high through 2023, indicating the genre was [not a mere fad](https://howtomarketagame.com/2023/01/09/are-vampire-survivor-likes-dead/#:~:text=Based%20on%20the%20graph%2C%20you,played%20more%20than%20Vampire%20Survivors) but sustained by new content
In fact, one analysis in early 2023 noted that multiple Vampire Survivor-inspired games were “making serious money”, for example 20 Minutes Till Dawn (which added manual twin-stick shooting to the formula) grossed about $500,000 in its first week after launch.
...
The addition of a weekly leaderboard in SupeRun directly targets the competitive players who want to compare their ability to others and maybe have everyone see their achievement.
...
On PC, indie games typically sell as “pay-to-own” products at relatively low prices (often $5–$20 range). This model has been proven in this genre – Vampire Survivors launched at just ~$3 and later ~$5. If the game succeeds then it is possible to add monetization via cosmetics or new levels.
...
The roguelike Horde Survival is riddled with competition with new games coming out each day. There is a risk where a bigger company has a similar idea by the time development is over. The opportunity though is that there is no game out there which takes this genre and give the player control and skill expression. 
